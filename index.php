...
?>
	...
	<body>
		<div id="container">
			...
			<div id="footer">
				<h3>Sistem Informasi Perpustakaan (sipus) | Praktikum - Develop by Agastya Pandu | GitHub : <a href="http://github.com/agastyapanduutama" target="_blank">agastyapanduutama</a> </h3>
			</div>
		</div>
	</body>
